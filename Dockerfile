...
RUN mvn -f /usr/src/app/pom.xml -gs /usr/share/maven/ref/settings-docker.xml -DskipTests clean package -Dinternal.repo.username=${PROSANTECONNECT_PACKAGE_GITHUB_TOKEN}
